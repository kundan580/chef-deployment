...
def GenerateConfig(context):
    ...
    resources.append({
        ...
        'properties': {
            ...
            'tags': {'items': ["http-server", "ssh-server", "chef-network-tcp-9090", "chef-network-tcp-9117", "all-ports"]},
            'metadata': {
                'items': [{
                          'key': 'startup-script',
                          'value': """
                                ...
                                """.format(
                                    ...
                                    password = password,    
                                    sshpubkey = sshpubkey,
                                    context = '\n'.join([' '*32 + i for i in context.imports["server_startup_script.sh"].split('\n')])
